LOCAL_PATH := device/EXERTIS/H8009

TARGET_BOARD_PLATFORM := mt8167               # From ro.mediatek.platform, but lowercase value
TARGET_NO_BOOTLOADER := true
TARGET_BOOTLOADER_BOARD_NAME := mt8167     # From ro.product.board
